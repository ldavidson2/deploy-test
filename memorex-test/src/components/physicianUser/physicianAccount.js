...
export default function PhysicianAccount() {
  ...
  const baseUrl = "http://18.224.38.65";
  const testId = ulid();
          ...
          <form className={classes.allFilters}>
            ...
            <div style={filterDisplay}>
              <div className={classes.filterForm}>
                ...
                <div className={classes.filterSection}>
                  <h4>Age</h4>
                  <input type="number" id="ageMin" name="ageMin" value={fields.ageMin} onChange={handleFieldChange} />
                  <label>To</label>
                  <input type="number" id="ageMax" name="ageMax" value={fields.ageMax} onChange={handleFieldChange} />
                </div>
              </div>
